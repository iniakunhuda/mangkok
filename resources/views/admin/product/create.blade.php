                    ...
                    @method('POST')
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <textarea cols="20" class="form-control" rows="5" name="desc"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <textarea cols="20" class="form-control" rows="10" name="desc_long"></textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-6">
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control"  name="price[real_price]">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control"  name="price[discount_price]">
                                    </div>
                                </div>
                            </div>
                        </div>
