...
<div id="appCapsule">
    ...
    <div class="section mt-5">
        <div class="card">
            <div class="card-body">
                <h2 class="mt-2">Detail Pesanan Saya</h2>
                <p class="mb-0">Kode Transaksi : <strong>{{ $pesanan['code'] }}</strong></p>
                <p class="mb-0">Nama Merchant : {{ $pesanan['merchant']['name'] }}</p>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @if($pesanan['status'] == "waiting")
                            <p class="mb-0">Menunggu Konfirmasi Pedagang</p>
                        @elseif($pesanan['status'] == "process")
                            <p class="mb-0">Tunggu Pedagang Datang</p>
                            <small>Estimasi 5 menit sampai ke lokasi kamu</small>
